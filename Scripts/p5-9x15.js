let images = [];
let selectedIndices = [];
let scalePercent = 0.85; // Slightly reduced for portrait format

// Dot grid variables - swapped from 16:9
const dotRows = 12;       // More rows for taller format
const dotCols = 8;        // Fewer columns for taller format
const dotSize = 6;
...
function setup() {
  createCanvas(506, 900); // 9:16 aspect ratio (swapped dimensions)
...
function calculateAreaDots() {
  ...
  // Define area boundaries - same percentages as 16:9
  const topHeight = height * 0.28;
